...
let AppComponent = class AppComponent {
    constructor(contenful, sanitizer) {
    ...
    ngOnInit() {
        ...
        /**URLS*/
        this.contenful.getContents('links').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(value => value[0])).subscribe((value) => {
        ...
        this.contenful.getContents('banner')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((fields) => ({ title: fields[0].fields.title, subTitle: fields[0].fields.subTitle, button: fields[0].fields.button, image: fields[0].fields.image.fields.file.url }))).subscribe(value => {
            this.banner = value;
        });
        /*PAIN POINT*/
        this.painPoint$ = this.contenful.getContents('painPoint')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((fields) => {
        ...
        this.contenful.getContents('howToUse')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((fields) => ({ iframe: fields[0].fields.iframe + '?autoplay=1', overlay: fields[0].fields.overlay.fields.file.url }))).subscribe(value => {
            this.howToUse = value;
        });
        /**Testimonials */
